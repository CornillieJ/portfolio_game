...
public class Generic:GameObject,IVisible,IInteractable,IHasInventory
{
    ...
    public Func<ResultAction[]> Interaction;
    ...
    public Generic(int x, int y, int width, int height, string graphicText, string noInteractionText, Func<ResultAction[]> interaction)
    {
        PositionX = x;
        PositionY = y;
        Width = width;
    ...
    {
        return !Interacted ? Interaction() : new []{ResultAction.NoMoreInteraction };
    }
